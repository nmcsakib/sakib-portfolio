...
<footer className="p-4 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 bg-slate-800">
    <span className="text-sm sm:text-center text-gray-400">© 2023 <a href="https://facebook.com/sakib.sjs" className="hover:underline"  rel="noreferrer" target="_blank">NMC Sakib</a>. All Rights Reserved.
    </span>
    <ul className="relative z-20 grid md:grid-cols-4 md:text-center grid-cols-2 items-center mt-3 sm:mt-0">
        <li>
